    ...
    describe('parse', function(){
       ...
       it('/hello.world',function(){
        ...
        it('http://test.com', function(){
            ...
            parsed.should.eql( {host:{protocol:"http",hostname:"test.com"} });
        ...
        it('file:///test.file', function(){
            ...
            parsed.should.eql( { host:{protocol:"file"},path:{base:"test.file"} });
        ...
        it('ftp://user:pass@test.com', function(){
            ...
            parsed.should.eql( {
              host: {protocol:"ftp",hostname:"test.com",username:"user",password:"pass"}
            });
