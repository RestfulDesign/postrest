...
module.exports = (function () {
     ...
     */
    PostRest.Connect = function (connection, credentials) {
        var postrest;
    ...
    Object.defineProperty(PostRest.prototype, '_user', {
        configurable: false,
        enumerable: false,
        get: function () {
            return this.connection.host && this.connection.host.username;
        }
    });
