...
module.exports = (function () {
    ...
    PostRest.prototype = {
        ...
        "use": function (connection) {
            ...
            // TODO: return new db instance instead of reconfiguring current instance
            if(typeof connection === 'string') {
                connection = utils.url.parse(connection);
            }

            utils.extend(true, this.connection, connection);

            if(this.connection.path && this.connection.path.name)
                this._collection = this.connection.path.name;
