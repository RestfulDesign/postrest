...
exports.document = function (db, suffix) {
    ...
    // collection name suffix as used by
    // the graph nodes collection api
    suffix = suffix || '';
    ...
    return {
        ...
        "create": function (document, collection) {
            ...
            return db.post(path + 'create/' + collection + suffix, document);
        },
        "update": function (id, document, collection) {
            collection = collection || db._collection;

            return db.put(path + collection + suffix + '/' + id, document);
        },
