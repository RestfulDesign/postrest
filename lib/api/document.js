...
exports.document = function (db, suffix) {
    ...
    return {
        "get": function (id, collection) {
            ...
            return db.get(path + 'get/' + collection + suffix + '/' + id);
        },
        "name": function(name,collection){
	    collection = collection || db._collection;

	    return db.get(path + 'name/' + collection + suffix + '/' + encodeURIComponent(name));
	},
        ...
        "set": function (id, name, document, collection) {
            if(typeof name === 'object') {
                collection = document;
                document = name;
                name = undefined;
            ...
            return db.post(path + 'set/' + collection + suffix + '/' + id, data);
        },
